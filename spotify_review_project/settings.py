"""
Django settings for spotify_review_project project.
...
SECRET_KEY = '6ps0*(+3^92$-npn@mq97g6+ws5&o3m8d)swgg#x6)510u@rx$'
...
ROOT_URLCONF = 'spotify_review_project.urls'
...
WSGI_APPLICATION = 'spotify_review_project.wsgi.application'
